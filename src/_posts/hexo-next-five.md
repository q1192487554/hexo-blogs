...
```
<!-- 网页加载条 -->
<script src="https://dreamingpoet.github.io/js/src/pace.min.js"></script>
```
...
具体的做法是:
在项目的根目录下添加一个 `gulpfile.js` 文件，文件内容参看 [源码](https://github.com/dreamingpoet/dreamingpoet.github.io/blob/resource/gulpfile.js)，这里我就不贴了。
...
然后在 `gulpfile.js` 里面写上相关代码，详情查看 [源码](https://github.com/dreamingpoet/dreamingpoet.github.io/blob/resource/gulpfile.js) 。
