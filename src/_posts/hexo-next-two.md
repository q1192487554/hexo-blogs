...
#### 5. 鼠标点击小红心的设置
  1. 将 [love.js](https://github.com/dreamingpoet/dreamingpoet.github.io/blob/master/js/src/love.js) 文件添加到 \themes\next\source\js\src 文件目录下。
...
#### 6. 背景的设置
  1. 将 [particle.js](https://github.com/dreamingpoet/dreamingpoet.github.io/blob/master/js/src/particle.js) 文件添加到 \themes\next\source\js\src 文件目录下。
  2. 找到 `\themes\next\layout\_layout.swing` 文件，** 在文件的后面，`</body>`标签之前 ** 添加以下代码：
  ``` html
  <!-- 背景动画 -->
